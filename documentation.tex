...
\begin{figure}[h!]
    ...
    \begin{tikzpicture}[scale=0.8]
        ...
        \node[below left] at (0,0) {}; % Remove coordinate label
        \node[above right] at (6,4) {}; % Remove coordinate label

        % Add axis labels
        \node[below=2pt] at (3,0) {x};
        \node[left=2pt] at (0,2) {y};
        ...
        % Use slightly larger nodes for visibility
        ...
        % Add a simple legend
        \node[below right, inner sep=5pt, draw, thick, anchor=south east] at (6,-0.5) { % Position legend below and to the right
            \begin{tabular}{ll}
